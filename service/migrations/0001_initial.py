    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clients', models.ManyToManyField(related_name='mailings', to='service.client', verbose_name='клиенты')),
            ],
        ),
        migrations.CreateModel(
            name='MailingLog',
            fields=[
                ...
                ('status', models.CharField(choices=[('success', 'Успешно'), ('failed', 'Не удалось')], verbose_name='статус попытки')),
